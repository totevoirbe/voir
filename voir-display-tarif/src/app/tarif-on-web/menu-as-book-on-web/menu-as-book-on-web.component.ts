...
@Component({
  selector: 'app-menu-as-book-on-web',
  templateUrl: './menu-as-book-on-web.component.html',
  styleUrls: ['./menu-as-book-on-web.component.css']
})

export class MenuAsBookOnWebComponent implements OnInit {
